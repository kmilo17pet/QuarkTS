 ...
 **/
    ...
    * using the 16 base and stores the result in the array given by @a str parameter.
    * @a str should be an array long enough to contain any possible value.
    * @param[in] value Value to be converted to a string.
    * @param[out] str Array in memory where to store the resulting null-terminated 
    * string.
