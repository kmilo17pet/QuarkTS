...
.LFB16:
	...
	call	printf
	.loc 1 93 0
	movl	_qCRTaskState_.4585(%rip), %eax
	cmpl	$100, %eax
	je	.L20
	cmpl	$100, %eax
	jg	.L21
...
.L24:
	...
	.loc 1 95 0
	movl	$95, _qCRTaskState_.4585(%rip)
	jmp	.L18
.L22:
	.loc 1 97 0
	leaq	.LC12(%rip), %rdx
	...
	call	_qEnqueueTaskEvent
	.loc 1 98 0
	movl	$98, _qCRTaskState_.4585(%rip)
	jmp	.L18
.L23:
	.loc 1 99 0
	movss	.LC13(%rip), %xmm1
	leaq	Timer.4584(%rip), %rcx
	call	_qSTimerSet
	.loc 1 100 0
	movl	$100, _qCRTaskState_.4585(%rip)
.L20:
...
.L29:
	...
	call	_qSTimerSet
	.loc 1 105 0
	movl	$105, _qCRTaskState_.4585(%rip)
	jmp	.L18
.L27:
	.loc 1 106 0
	leaq	.LC18(%rip), %rdx
	...
	call	_qEnqueueTaskEvent
	.loc 1 108 0
	movl	$108, _qCRTaskState_.4585(%rip)
.L25:
...
.L30:
	...
	call	_qEnqueueTaskEvent
	.loc 1 111 0
	movl	$111, _qCRTaskState_.4585(%rip)
	nop
.L18:
	.loc 1 113 0
	addq	$40, %rsp
...
.LFB22:
	...
	.seh_endprologue
	.loc 1 139 0
	movl	_qCRTaskState_.4614(%rip), %eax
	cmpl	$141, %eax
	je	.L39
	cmpl	$141, %eax
	jg	.L40
...
.L41:
	...
	call	putchar
	.loc 1 141 0
	movl	$141, _qCRTaskState_.4614(%rip)
	jmp	.L37
.L39:
	.loc 1 142 0
	movl	$98, %ecx
	call	putchar
	.loc 1 143 0
	movl	$143, _qCRTaskState_.4614(%rip)
	jmp	.L37
.L42:
	.loc 1 144 0
	movl	$99, %ecx
	call	putchar
	.loc 1 145 0
	movl	$145, _qCRTaskState_.4614(%rip)
	nop
.L37:
	.loc 1 148 0
	addq	$32, %rsp
...
.LFB23:
	...
	.seh_endprologue
	.loc 1 152 0
	movl	_qCRTaskState_.4624(%rip), %eax
	cmpl	$154, %eax
	je	.L48
	cmpl	$154, %eax
	jg	.L49
...
.L50:
	...
	call	putchar
	.loc 1 154 0
	movl	$154, _qCRTaskState_.4624(%rip)
	jmp	.L46
.L48:
	.loc 1 155 0
	movl	$50, %ecx
	call	putchar
	.loc 1 156 0
	movl	$156, _qCRTaskState_.4624(%rip)
	jmp	.L46
.L51:
	.loc 1 157 0
	leaq	.LC5(%rip), %rcx
	call	puts
	.loc 1 158 0
	movl	$158, _qCRTaskState_.4624(%rip)
	nop
.L46:
	.loc 1 161 0
	addq	$32, %rsp
...
.LFE24:
	.seh_endproc
.lcomm x.4551,4,4
.lcomm Maquina1.4577,56,32
	.data
	.align 4
_qCRTaskState_.4585:
	.long	-32766
.lcomm Timer.4584,12,4
	.align 4
_qCRTaskState_.4614:
	.long	-32766
	.align 4
