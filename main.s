...
.LFB16:
	...
	call	printf
	.loc 1 85 0
	movl	__qCurrentTaskState.4534(%rip), %eax
	cmpl	$90, %eax
	je	.L20
	cmpl	$90, %eax
	jg	.L21
...
.L22:
	...
	.loc 1 87 0
	movl	$87, __qCurrentTaskState.4534(%rip)
	jmp	.L18
.L23:
	.loc 1 89 0
	leaq	.LC10(%rip), %rdx
	...
	call	_qEnqueueTaskEvent
	.loc 1 90 0
	movl	$90, __qCurrentTaskState.4534(%rip)
	jmp	.L18
.L20:
	.loc 1 92 0
	leaq	.LC11(%rip), %rdx
	...
	call	_qEnqueueTaskEvent
	.loc 1 94 0
	movl	$94, __qCurrentTaskState.4534(%rip)
	jmp	.L18
.L26:
	.loc 1 96 0
	leaq	.LC13(%rip), %rdx
	...
	call	_qEnqueueTaskEvent
	.loc 1 97 0
	movl	$97, __qCurrentTaskState.4534(%rip)
	jmp	.L18
.L24:
	.loc 1 99 0
	leaq	.LC14(%rip), %rdx
	...
	call	_qEnqueueTaskEvent
	.loc 1 100 0
	movl	$100, __qCurrentTaskState.4534(%rip)
	nop
.L18:
	.loc 1 108 0
	addq	$40, %rsp
...
.LFE21:
	.seh_endproc
.lcomm x.4502,4,4
.lcomm Maquina1.4527,24,16
.lcomm __qCurrentTaskState.4534,4,4
	.section .rdata,"dr"
	.align 4
.LC16:
	.long	1008981770
