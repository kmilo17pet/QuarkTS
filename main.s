...
.L19:
	...
	call	printf
	.loc 1 91 0
	movl	_qCRTaskState_.4559(%rip), %eax
	cmpl	$98, %eax
	je	.L21
	cmpl	$98, %eax
	jg	.L22
...
.L25:
	...
	.loc 1 93 0
	movl	$93, _qCRTaskState_.4559(%rip)
	jmp	.L18
.L23:
	.loc 1 95 0
	leaq	.LC13(%rip), %rdx
	...
	call	_qEnqueueTaskEvent
	.loc 1 96 0
	movl	$96, _qCRTaskState_.4559(%rip)
	jmp	.L18
.L24:
	.loc 1 98 0
	movl	$98, _qCRTaskState_.4559(%rip)
.L21:
...
.L30:
	...
	call	_qSTimerSet
	.loc 1 103 0
	movl	$103, _qCRTaskState_.4559(%rip)
	jmp	.L18
.L28:
	.loc 1 105 0
	leaq	.LC18(%rip), %rdx
	...
	call	_qEnqueueTaskEvent
	.loc 1 107 0
	movl	$107, _qCRTaskState_.4559(%rip)
.L26:
...
.L31:
	...
	call	_qEnqueueTaskEvent
	.loc 1 110 0
	movl	$110, _qCRTaskState_.4559(%rip)
	nop
.L18:
	.loc 1 112 0
	addq	$40, %rsp
...
.LFB22:
	...
	.seh_endprologue
	.loc 1 139 0
	movl	_qCRTaskState_.4588(%rip), %eax
	cmpl	$141, %eax
	je	.L40
	cmpl	$141, %eax
	jg	.L41
...
.L42:
	...
	call	putchar
	.loc 1 141 0
	movl	$141, _qCRTaskState_.4588(%rip)
	jmp	.L38
.L40:
	.loc 1 142 0
	movl	$98, %ecx
	call	putchar
	.loc 1 143 0
	movl	$143, _qCRTaskState_.4588(%rip)
	jmp	.L38
.L43:
	.loc 1 144 0
	movl	$99, %ecx
	call	putchar
	.loc 1 145 0
	movl	$145, _qCRTaskState_.4588(%rip)
	nop
.L38:
	.loc 1 148 0
	addq	$32, %rsp
...
.LFB23:
	...
	.seh_endprologue
	.loc 1 152 0
	movl	_qCRTaskState_.4598(%rip), %eax
	cmpl	$154, %eax
	je	.L49
	cmpl	$154, %eax
	jg	.L50
...
.L51:
	...
	call	putchar
	.loc 1 154 0
	movl	$154, _qCRTaskState_.4598(%rip)
	jmp	.L47
.L49:
	.loc 1 155 0
	movl	$50, %ecx
	call	putchar
	.loc 1 156 0
	movl	$156, _qCRTaskState_.4598(%rip)
	jmp	.L47
.L52:
	.loc 1 157 0
	leaq	.LC5(%rip), %rcx
	call	puts
	.loc 1 158 0
	movl	$158, _qCRTaskState_.4598(%rip)
	nop
.L47:
	.loc 1 161 0
	addq	$32, %rsp
...
.LFE24:
	.seh_endproc
.lcomm x.4525,4,4
.lcomm Maquina1.4551,56,32
.lcomm Timer.4558,24,16
	.data
	.align 4
_qCRTaskState_.4559:
	.long	-32766
