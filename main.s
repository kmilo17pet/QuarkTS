...
blinktaskCallback:
	...
	.seh_stackalloc	40
	.seh_endprologue
	movl	_qCRTaskState_.4004(%rip), %eax
	cmpl	$138, %eax
	je	.L66
	jle	.L77
	cmpl	$147, %eax
...
.L79:
	leaq	.LC26(%rip), %rcx
	call	puts
	leaq	tmr.4001(%rip), %rcx
	movss	.LC27(%rip), %xmm1
	call	qSTimerSet
	movl	$150, _qCRTaskState_.4004(%rip)
.L59:
	leaq	tmr.4001(%rip), %rcx
	call	qSTimerExpired
	testb	%al, %al
...
.L55:
	...
	movss	.LC24(%rip), %xmm1
	call	qSTimerSet
	movl	$137, _qCRTaskState_.4004(%rip)
.L56:
	leaq	tmr.4001(%rip), %rcx
	call	qSTimerExpired
	testb	%al, %al
	je	.L51
	movl	$138, _qCRTaskState_.4004(%rip)
.L53:
	cmpl	%esi, %ebx
	je	.L51
	addl	$1, %esi
...
.L60:
	...
	xorl	%edx, %edx
	call	qTaskSendEvent
	movl	$147, _qCRTaskState_.4004(%rip)
.L58:
	leaq	tmr.4001(%rip), %rcx
	call	qSTimerExpired
	testb	%al, %al
