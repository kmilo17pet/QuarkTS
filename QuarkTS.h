...
#define __qTOSTRING(x) __qSTRINGIFY(x)
    ...
    #define qTraceUnsignedBinary(Var)       __qtrace_func (__qAT(), __QTRACE_FUNC, #Var "=", qUtoA((uint32_t)(Var), qDebugTrace_Buffer,  2), NULL, 0)
    #define qTraceUnsignedOctal(Var)        __qtrace_func (__qAT(), __QTRACE_FUNC, #Var "=", qUtoA((uint32_t)(Var), qDebugTrace_Buffer,  8), NULL, 0)
    #define qTraceUnsignedHexadecimal(Var)  __qtrace_func (__qAT(), __QTRACE_FUNC, #Var "=", qUtoA((uint32_t)(Var), qDebugTrace_Buffer, 16), NULL, 0)
