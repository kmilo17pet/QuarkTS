...
int main(int argc, char** argv) {  
    ...
    qStateMachine_Setup( &AutomatedControl_SM, AutomatedControl_Accelerating_State, NULL );
    qStateMachine_Setup( &LEDBlink_FSM, AutomatedControl_Sub_LEDOFF, NULL );
    ...
    qOS_Add_StateMachineTask(  &SMTask, qMedium_Priority, 0.1f, &Top_SM, Top_Idle_State, NULL, qEnabled, NULL); 
