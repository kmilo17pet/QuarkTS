/*This file is part of the QuarkTS OS distribution.*/
    ...
    #define Q_FSM_BUILTIN_TIMEOUTS      ( 1 )       /*< Built-in timeouts fot every Finite State Machine object*/
    ...
    #define Q_ATCLI_INPUT_FIX           ( 1 )       /*< Used to remove non-graph chars at the CLI input*/
